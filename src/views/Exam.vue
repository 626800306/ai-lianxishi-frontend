      ...
      <div v-for="(group, type) in groupedQuestions" :key="type" class="question-group">
        ...
        <div v-for="(question, index) in group" :key="question.id" class="question-card">
          <div class="question-title">
            <span class="question-number">第 {{ question.globalIndex }} 题 ({{ question.score }}分)</span>
          ...
          <div class="question-options">
            ...
            <el-radio-group v-else-if="question.type == 'JUDGE'" v-model="answers[question.id]" class="judge-options">
              <el-radio label="TRUE" class="judge-item">正确</el-radio>
              <el-radio label="FALSE" class="judge-item">错误</el-radio>
            </el-radio-group>
            <!-- 简答题 -->
            <el-input
...
const getExamData = async () => {
  try {
    ...
    // 正常的考试逻辑
    totalTime.value = (examRecord.value.duration || 0) * 60;
